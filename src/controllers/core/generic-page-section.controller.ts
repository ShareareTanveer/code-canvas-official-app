...
import sectionService from '../../services/core/generic-page-section.service';
import {
...
const create: IController = async (req, res) => {
  try {
    const params: CreateGenericPageSectionDTO = req.body;
...
const update: IController = async (req, res) => {
  try {
    const id: number = parseInt(req.params.id, 10);
    const params: UpdateGenericPageSectionDTO = req.body;
