...
import service from '../../services/wishlist/wishlist.service';
import ApiUtility from '../../utilities/api.utility';
import { IBaseQueryParams } from 'common.interface';
import { IAddToWishlist } from 'wishlist/wishlist.interface';
...
const create: IController = async (req, res) => {
  try {
    ...
    const params: IAddToWishlist = {
      product: req.body.product,
      user: user,
    };
    const { data, added } = await service.toggleWishlistProduct(params);
    const status = added
